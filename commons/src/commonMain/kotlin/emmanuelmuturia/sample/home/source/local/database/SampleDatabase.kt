 ...
 */
package emmanuelmuturia.sample.home.source.local.database
...
import emmanuelmuturia.sample.home.source.local.typeConverter.SampleTypeConverters
...
@TypeConverters(value = [SampleTypeConverters::class])
